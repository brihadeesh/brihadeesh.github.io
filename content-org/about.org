...
#+hugo: {{< figure src="/img/goose_IV-2.jpg" alt="A white and gray cat with pale green eyes" class="right rounded border-solid border-2 w-40 h-auto" caption="Goose V. Photo by Brihadeesh S, Jan 2023" >}}
...
#+hugo: {{< figure src="/img/goose_IV-1.jpg" alt="A white and gray cat with pale green eyes" class="rounded border-solid border-2 w-40 h-auto" caption="Goose V. Photo by Brihadeesh S, Oct 2023" >}}
...
Bluesky [[https://bsky.app/profile/peregrinator.site][~[at] peregrinator.site~]]. My Sourcehut is at [[https://git.sr.ht/~peregrinator][~~peregrinator~]]
and my Github is at [[https://github.com/brihadeesh][~brihadeesh~]]. Support me at [[https://www.buymeacoffee.com/peregrinator][buymeacoffee]].
