...
currently run a [[https://voidlinux.org][Void Linux]] installation with the pure-gtk version of
...
|------------+-----------------------------------------------------|
| ~Mastodon~   | ~[at] peregrinator on~  [[https://toot.cat/@peregrinator][~toot.cat~]] ~or~ [[https://ecoeco.social/@peregrinator][~ecoevo.social~]] |
|------------+-----------------------------------------------------|
| ~IRC~        | ~peregrinator on~ [[https://libera.chat][~libera.chat~]]                       |
|------------+-----------------------------------------------------|
| ~Sourcehut~  | [[https://sr.ht/~peregrinator][~sr.ht/~peregrinator~]]                               |
|------------+-----------------------------------------------------|
