...
#+hugo: {{< figure src="img/about.jpg" alt="Author wearing a red t-shirt with their hair down" class="rounded w-36 overflow-hidden float-left mr-6 !mb-0 !mt-1 mx-auto items-start" >}}
...
source for this website is on my [[https://github.com/brihadeesh/peregrinator.site][Github]] and [[https://git.sr.ht/~peregrinator/emacs.peregrinator.site][Sourcehut]].
...
#+hugo: {{< embed-pdf "/pdfs/jul2020_AJCB.pdf" >}}
...
#+hugo: {{< embed-pdf "/pdfs/jun2015_IndianBirds.pdf" >}}
