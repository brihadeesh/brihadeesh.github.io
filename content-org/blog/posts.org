...
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :series "Listening habits" :bsky "https://bsky.app/profile/peregrinator.site/post/3lfs43xp5vk2s"
...
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :series "Blogging with Emacs" :bsky "https://bsky.app/profile/peregrinator.site/post/3li7fx3v4m22d"
...
** DONE Potentially returning to Sourcehut and my FOSS roots
:PROPERTIES:
:EXPORT_FILE_NAME: potentially-returning-to-sourcehut-and-my-foss-roots
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :series "Blogging with Emacs" :bsky "https://bsky.app/profile/peregrinator.site/post/3ljxcd3k5js2o"
:EXPORT_HUGO_AUTO_SET_LASTMOD: t
:EXPORT_DATE: [2025-03-09 Sun 19:36]
:END:

I wrote about why I'd been considering [[/blog/2025/02/the-sourcehut-builds-dilemma/][moving back to Github]] to host
the source code for the blog last month and talked about why Sourcehut
builds and the [[https://srht.site/limitations][restrictions]] on content were my primary motive. I also
...
[[https://github.com/jpanther/congo][The theme]] looked nice, with all the soft pastel colours and the fancy
...
[[https://github.com/search?q=repo%3Ajpanther%2Fcongo++language%3AJavaScript&type=code][little bit of JavaScript]] too. Now, it's not that /all/ JS is bad but
...
[[https://github.com/nodejh/hugo-theme-mini][Mini]] seemed like something easy to work with and I gave it a shot but
...
[[https://github.com/LukasJoswiak/etch/][Etch]] was a theme I'd tried out when I initially started out with this
blog, after switching to Hugo and my whole Emacs-based setup. I had
discarded it for something based off [[https://drewdevault.com/][Drew's website]]. But looking at
[[https://neilzone.co.uk/][Neil's blog]], which I'd come across while searching for something, I
...
actually part of the theme's [[https://github.com/LukasJoswiak/etch/wiki/i18n][wiki]]. I also added a layout for the
...
I added the [[https://git.sr.ht/~sircmpwn/openring][openring]] template from earlier, making it very simple and
...
The font is as always, [[https://github.com/samvk/monorale-raleway-sober][Monorale]] and the code blocks have Prot's [[https://protesilaos.com/emacs/modus-themes][Modus]]
theme, like what I had on my own Emacs until recently.

*** Issues with Sourcehut builds
...
pushed a commit to the repo — it was [[https://lists.sr.ht/~sircmpwn/sr.ht-discuss/%3CtMVFgp8GaDoesSDCvSDPa67dbKRxx-o-UWlVVDLBrMNkp3m-hGsMLU1bJ1wd4GE7rHjk8OzLU7Tex0Ko9e5jGM1Y5qu52Sb-ODc_drZDsXk=@protonmail.com%3E][while openring was being run]] —
...
added a [[/about#blogroll][blogroll]] to list out all the blogs I read.
#+end_info

** DONE Should I still be using Firefox?
:PROPERTIES:
:EXPORT_FILE_NAME: should-i-still-be-using-firefox
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :bsky "https://bsky.app/profile/peregrinator.site/post/3ljxjgnqedc2i"
:EXPORT_HUGO_AUTO_SET_LASTMOD: t
:EXPORT_DATE: [2025-03-09 Sun 22:22]
:END:
...
abuses personal data[fn:1: I'm sure there are adequate articles about
this]. Recent events with Mozilla that have changed the way Firefox
...
#+hugo: {{< x user="theo" id="1895630175939019125" >}}

#+hugo: {{< figure src="/images/firefox_diff.jpg" alt="a diff showing the removal of an FAQ item regarding whether personal data is sold by Firefox" caption="a screenshot of a diff from the source code of Firefox, from the tweet above" >}}
...
data in some form or the other[fn:3:
...
privacy. [[https://librewolf.net][Librewolf]] is a privacy focused fork that I've seen mentioned
in a lot of places. Void Linux doesn't offer a package for this
although there is a repo with a [[https://github.com/index-0/librewolf-void][build template]] for it. I actually
...
remember using [[https://github.com/Divested-Mobile/Mull-Fenix][Mull]] which is apparently orphaned now, there was also
Fennec and some others I tried) and Linux.

[[https://arc.net/][Arc Browser]] seems like a good choice for Windows and I've been using
...
#+begin_info
~Update on 15.03.2025~:
I've moved to Librewolf on Void Linux and [[https://gitlab.com/ironfox-oss/IronFox][IronFox]] on Android.
#+end_info

** DONE What even is skramz
:PROPERTIES:
:EXPORT_FILE_NAME: what-even-is-skramz
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :series "Listening habits" :bsky "https://bsky.app/profile/peregrinator.site/post/3lk6yzb53vc2f"
:EXPORT_DATE: [2025-03-12 Tue 17:16]
:END:

#+hugo: {{< figure src="https://f4.bcbits.com/img/a2964742903_10.jpg" class="left" alt="album cover for Serein's Rivers of Living Water" caption="[Serein - Rivers of Living Water](https://sereinthemetalband.bandcamp.com/album/rivers-of-living-water)" >}}
...
albums. There was a [[https://putriddefecation.bandcamp.com/album/tales-from-the-toilet][toilet themed slam band]] that put out something
...
What started as me just checking out something [[https://bsky.app/profile/adzes.bsky.social][Adzes]] posted on Bluesky
went on to become a full fledged phase for me. It was Orphan Donor's
[[/blog/2025/01/what-even-is-skramz/#orphan-donor-old-patterns][Old Patterns]] and it went from there to checking out a whole bunch of
...
become a regular part of what we listen to like [[https://bsky.app/profile/colinbwilliams.com/post/3lh5wbkobac2n][this one]] from [[https://bsky.app/profile/colinbwilliams.com‬][Colin]]
where I got to talk about my relationship to hardcore and skramz.

#+hugo: {{< bsky link="https://bsky.app/profile/colinbwilliams.com/post/3lh5wbkobac2n" >}}
...
kind. [[https://bsky.app/profile/posttim.bsky.social][Tim]] pointed two of these out:

1. [[https://bsky.app/profile/posttim.bsky.social/feed/aaacbrxni6bre][Tim's Screamo/Hardcore/Crust]] feed
2. [[https://bsky.app/profile/letsgetpivotal.bsky.social/feed/aaab3kjhsnl3a][the other Screamo]] feed (by [[https://bsky.app/profile/letsgetpivotal.bsky.social][letsgetpivotal]])

Other ways to find new music within the genre is to follow certain
labels. [[https://zegemabeachrecords.bandcamp.com/][Zegema Beach Records]] and (I think) [[https://nofuneralsound.bandcamp.com/][no funeral records]] are some
...
has become very dear over the last month. [[https://bsky.app/profile/adzes.bsky.social][Adzes]] posted about this a
...
recently when [[https://bsky.app/profile/garydavidson.bsky.social][Gary]] suggested them to me along with Dreamwell's [[https://dreamwell.bandcamp.com/album/modern-grotesque][Modern
Grotesque]] (also worth listening to for it's unique take on screamo.)
...
Mystic Sisters very nearly featured on my 2022 [[/blog/2023/02/albums-of-the-year-2022/][Albums of the Year]]
...
on Bluesky and Tim mentioned another such: [[https://thycatafalqueuk.bandcamp.com/album/meta][Meta]] by Thy Catafalque
which has a similar sainted cat on it.

#+hugo: {{< figure src="https://f4.bcbits.com/img/a0484003818_16.jpg" alt="album cover for Crowning's Oaktails split" caption="[Crowning/Oaktails split](https://crowningpool.bandcamp.com/album/oaktails-split)" >}}
...
band, [[https://oaktails.bandcamp.com/][Oaktails]], whose only other release is [[https://oaktails.bandcamp.com/album/what-i-think-what-i-love][What I Think, What I Love]]
...
[[https://kenmode.bandcamp.com/album/null][Null]] or [[https://kenmode.bandcamp.com/album/void][Void]], I can't remember which. The album plays out quite
smoothly, it's almost as if it's one song split into seven. The riffs
are intense and melodic. It is a tranquil and surprisingly /happy/
...
This was one of [[https://bsky.app/profile/faithhealer.bsky.social][Faith Healer]]'s recommendations. He'd also suggested
Dead in the Dirt along with this which I've talked about [[/blog/2025/03/what-even-is-skramz/#dead-in-the-dirt-the-blind-hole][later on]] in
...
form Dead in the Dirt and [[https://infernalcoil.bandcamp.com][Infernal Coil]], one of my favourite death
metal bands.
...
this is one of the best I've come across. Tim and (I think) [[https://bsky.app/profile/neuronaraka.bsky.social][B]]
mentioned this a few times and I checked it out after that. [[https://bsky.app/profile/av4apod.bsky.social][...And
Vol. 4 All]] wrote a [[https://musipediaofmetal.blogspot.com/2023/02/reviews-stormo-ddent-sermon-cadaver.html][review]] for it too. The most startling feature of
...
They have a new full-length that releases [[https://stormo.bandcamp.com/album/tagli-talee-2][March 21]]!

The album was released through Prosthetic Records in February 2023.

**** athousandangelsandseven - athousandangelsanseven

#+hugo: {{< bandcamp id="3339183858" >}}
...
#+hugo: {{< bandcamp id="1294017689" >}}

[[https://bsky.app/profile/sublation.bsky.social][Max]] from [[https://sublation.bandcamp.com][Sublation]] announced that he had played a guitar solo for this
album with a slide (?) and he describes it as an "improvised, fully
unhinged" one. Alice Simard, who I'd talked about on my [[/blog/2025/01/no-more-eoy-lists-for-music/][last article]]
...
[[https://bsky.app/profile/theoriginalkep.bsky.social][Kep]] put me onto Bloodcrusher last year when they had put out their
...
Unlike their more recent album, which I'd talked about on my [[/blog/2023/02/albums-of-the-year-2022/#wake-thought-form-descent][2022
end-of-year list]], this is pretty much a solidly death metal infused
...
** DRAFT Very little birding in Jharkhand
:PROPERTIES:
:EXPORT_FILE_NAME: very-little-birding-in-jharkhand
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :series "Birding journals"
:EXPORT_DATE: [2025-03-13 Thu 01:48]
:END:
