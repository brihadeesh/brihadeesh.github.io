...
** DRAFT The Sourcehut builds dilemma
:PROPERTIES:
:EXPORT_FILE_NAME: the-sourcehut-builds-dilemma
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :series "Blogging with Emacs" :series_order 4
:EXPORT_DATE: [2025-02-13 Thu 11:46]
:END:
...
doesn't work on the [[https://peregrinator.site][site]] deployed from my [[https://git.sr.ht/~peregrinator/peregrinator.site][Sourcehut repo]].
